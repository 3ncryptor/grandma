...
# A teammate's shared project memory waiting to be pulled. Reads a cache written by a detached
# poll, so this never waits on GitHub (silence with GRANDMA_NO_KNIT_CHECK=1).
grandma_knit_notice
